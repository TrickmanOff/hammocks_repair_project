from test_net import create_net
from pm4py.visualization.petri_net import visualizer as pn_visualizer
from net_helpers import get_transition_by_label
...
parameters = {
    hammocks_covering.Parameters.HAMMOCK_SOURCE_NODE_TYPE: hammocks_covering.NodeTypes.PLACE_TYPE | hammocks_covering.NodeTypes.NOT_HIDDEN_TRANS_TYPE,
    hammocks_covering.Parameters.HAMMOCK_SINK_NODE_TYPE: hammocks_covering.NodeTypes.PLACE_TYPE | hammocks_covering.NodeTypes.NOT_HIDDEN_TRANS_TYPE
}
