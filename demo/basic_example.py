...
HamParams = ham_repl_algo.Parameters
NodeTypes = ham_repl_algo.NodeTypes
NaiveParams = naive_log_algo.Parameters
# parameters
parameters = {
    ham_repl_algo.Parameters.HAMMOCK_PERMITTED_SOURCE_NODE_TYPE: 
    ham_repl_algo.NodeTypes.PLACE_TYPE | ham_repl_algo.NodeTypes.NOT_HIDDEN_TRANS_TYPE,
    ham_repl_algo.Parameters.HAMMOCK_PERMITTED_SINK_NODE_TYPE:
    ham_repl_algo.NodeTypes.PLACE_TYPE | ham_repl_algo.NodeTypes.NOT_HIDDEN_TRANS_TYPE,
    naive_log_algo.Parameters.ALIGNMENTS_MODIFICATION_MODE:
    naive_log_algo.AlignmentsModificationMode.LOG2SYNC, # to prevent alignments recalculation
}
